package com.miracle.ffmpeg.Extra;
...
import com.miracle.ffmpeg.Utils.RangeSeekBar;
        ...
        reverseVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedVideoUri != null) {
                    ...
                    tvDialogText.setText("The process will take some time.Please be patient.");
                    tvDialogSubmit.setText("Okay");
                    tvDialogSubmit.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            String yourRealPath = getPath(MainActivity1.this, selectedVideoUri);
...
//                }
            ...
            ffmpeg.execute(Arrays.toString(command), new ExecuteBinaryResponseHandler() {
                ...
                public void onSuccess(String s) {
                    ...
                    if (choice == 1 || choice == 2 || choice == 5 || choice == 6 || choice == 7) {
                        Intent intent = new Intent(MainActivity1.this, PreviewActivity.class);
                        intent.putExtra(FILEPATH, filePath);
                        startActivity(intent);
                    } else if (choice == 3) {
                        Intent intent = new Intent(MainActivity1.this, PreviewImageActivity.class);
                        intent.putExtra(FILEPATH, filePath);
                        startActivity(intent);
                    } else if (choice == 4) {
                        Intent intent = new Intent(MainActivity1.this, AudioPreviewActivity.class);
                        intent.putExtra(FILEPATH, filePath);
                        startActivity(intent);
                    } else if (choice == 8) {
                        choice = 9;
    ...
    private Dialog showSingleOptionTextDialog(Context mContext) {
        Dialog textDialog = new Dialog(mContext);
        ...
        textDialog.setContentView(R.layout.extra_dialog_singleoption_text);
